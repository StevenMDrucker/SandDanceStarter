declare module vp {
    ...
    function extendArrayWithHelpers(value: boolean): void;
}
...
declare module vp.utils {
    ...
    class scannerClass {
        ...
        private getIdToken(str, ch, index);
...
declare module vp.chartFrame {
    ...
    class axisBaseClass<T> implements IMarkBasedVisualization<T> {
        ...
        getActualLabelRotation(maxMeasuredWidth: number, maxMeasuredHeight: number, axisSize: number, labelCount: number): LabelRotation.none | LabelRotation.rotate45 | LabelRotation.rotateMinus45 | LabelRotation.rotate90 | LabelRotation.rotateMinus90;
...
declare module vp.dom {
    class selectedSet implements IWrapper<selectedSet> {
        ...
        getBounds(relToParent?: boolean, includePadding?: boolean): any;
...
declare module vp.dom {
    ...
    class singleWrapperSuperClass<T> implements IWrapper<T> {
        ...
        id(): string;
        id(value: string): T;
        getBounds(relToParent?: boolean, includePadding?: boolean): ClientRect;
...
declare module vp.color {
    ...
    function colorFromPalette(palette: any, index: any, firstPaletteIndex?: number, isCycling?: boolean): any;
...
declare module vp.events {
    ...
    class EventTracker {
        ...
        constructor(eventName: string, callback: any, useCapturePhase: boolean);
    }
    function triggerResize(elem: any): void;
    function wheelDelta(evt: any): any;
    function detach(elem: any, eventName?: string, funcToCall?: any, useCapture?: boolean): void;
...
declare module vp.dom {
    ...
    function getBounds(elem: any, relToParent?: boolean, includePadding?: boolean): ClientRect;
    ...
    function totalWidth(elem: any): any;
    function totalHeight(elem: any): any;
...
declare module vp.utils {
    ...
    function compareArrays(aray1: any[], aray2: any[]): boolean;
...
declare module vp.colorPalettes {
    ...
    function interpolate(colors: string[], steps: number): any[];
